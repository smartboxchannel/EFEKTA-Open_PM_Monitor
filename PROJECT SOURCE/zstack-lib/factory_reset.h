...
/******************************************************************************
 * Constants - Factory Reset Configuration
 *****************************************************************************/

#ifndef FACTORY_RESET_HOLD_TIME_LONG
    #define FACTORY_RESET_HOLD_TIME_LONG ((uint32)9 * 1000)   // 9 seconds
#endif

#ifndef FACTORY_RESET_HOLD_TIME_FAST
    #define FACTORY_RESET_HOLD_TIME_FAST 2000                 // 2 seconds
#endif
    ...
    #define FACTORY_RESET_BOOTCOUNTER_RESET_TIME 10 * 1000    // 10 seconds
#endif
